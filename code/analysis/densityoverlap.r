...
# Added 25 Oct: function to give the median pairwise distance between species MEANS, to compare the no-ITV situation.
# Uses the weighted median since we have settled on that.
