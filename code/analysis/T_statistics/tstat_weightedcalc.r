...
i2015gran <- with(mam_capture_sitemerge, year == 2015 & Pineda_Main_food %in% c('Granivore'))
i2015herb <-  with(mam_capture_sitemerge, year == 2015 & Pineda_Main_food %in% c('Herbivore'))
i2015gen <- with(mam_capture_sitemerge, year == 2015 & Pineda_Main_food %in% c('Generalist'))
...
plottable_gran <- table(factor(mam_capture_sitemerge$plotID[i2015gran]))
plottable_herb <- table(factor(mam_capture_sitemerge$plotID[i2015herb]))
plottable_gen <- table(factor(mam_capture_sitemerge$plotID[i2015gen]))
...
plotuse_gran <- names(plottable_gran)[plottable_gran > 4]
plotuse_herb <- names(plottable_herb)[plottable_herb > 4]
plotuse_gen <- names(plottable_gen)[plottable_gen > 4]
...
i2015gran <- i2015gran & mam_capture_sitemerge$plotID %in% plotuse_gran
i2015herb <- i2015herb & mam_capture_sitemerge$plotID %in% plotuse_herb
i2015gen <- i2015gen & mam_capture_sitemerge$plotID %in% plotuse_gen
...
traits_mam15gran <- mam_capture_sitemerge[i2015gran, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
traits_mam15herb <- mam_capture_sitemerge[i2015herb, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
traits_mam15gen <- mam_capture_sitemerge[i2015gen, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
...
sites15gran <- unique(mam_capture_sitemerge$siteID[i2015gran])
plots15gran <- unique(mam_capture_sitemerge$plotID[i2015gran])
sites15herb <- unique(mam_capture_sitemerge$siteID[i2015herb])
plots15herb <- unique(mam_capture_sitemerge$plotID[i2015herb])
...
plotregpoollist_mam15gran_iucn <- lapply(reg_pool[plots15gran], function(x) mam_capture_sitemerge[x, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')])
plotregpoollist_mam15herb_iucn <- lapply(reg_pool[plots15herb], function(x) mam_capture_sitemerge[x, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')])
plotregpoollist_mam15gen_iucn <- lapply(reg_pool[plots15gen], function(x) mam_capture_sitemerge[x, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')])
...
plotregpoollist_mam15gran_siteonly <- lapply(plots15gran, function(x) {
  spp <- unique(mam_capture_sitemerge$taxonID[mam_capture_sitemerge$siteID == substr(x, 1, 4)])
  mam_capture_sitemerge[mam_capture_sitemerge$taxonID %in% spp, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
})
plotregpoollist_mam15herb_siteonly <- lapply(plots15herb, function(x) {
  spp <- unique(mam_capture_sitemerge$taxonID[mam_capture_sitemerge$siteID == substr(x, 1, 4)])
  mam_capture_sitemerge[mam_capture_sitemerge$taxonID %in% spp, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
})
plotregpoollist_mam15gen_siteonly <- lapply(plots15gen, function(x) {
  spp <- unique(mam_capture_sitemerge$taxonID[mam_capture_sitemerge$siteID == substr(x, 1, 4)])
  mam_capture_sitemerge[mam_capture_sitemerge$taxonID %in% spp, c('hindfootLength', 'earLength', 'tailLength', 'totalLength', 'weight', 'logweight')]
})
...
names(plotregpoollist_mam15gran_siteonly) <- plots15gran
names(plotregpoollist_mam15herb_siteonly) <- plots15herb
names(plotregpoollist_mam15gen_siteonly) <- plots15gen
...
traits_i <- list(traits_mam15gg, traits_mam15gh, traits_mam15ggh, traits_mam15gran, traits_mam15herb, traits_mam15gen, traits_mam15gg, traits_mam15gh, traits_mam15ggh, traits_mam15gran, traits_mam15herb, traits_mam15gen)[[task]]
i_i <- list(i2015generalistsgranivores, i2015generalistsherbivores, i2015threeguilds, i2015gran, i2015herb, i2015gen, i2015generalistsgranivores, i2015generalistsherbivores, i2015threeguilds, i2015gran, i2015herb, i2015gen)[[task]]
pool_i <- list(plotregpoollist_mam15gg_iucn, plotregpoollist_mam15gh_iucn, plotregpoollist_mam15ggh_iucn, plotregpoollist_mam15gran_iucn, plotregpoollist_mam15herb_iucn, plotregpoollist_mam15gen_iucn, plotregpoollist_mam15gg_siteonly, plotregpoollist_mam15gh_siteonly, plotregpoollist_mam15ggh_siteonly, plotregpoollist_mam15gran_siteonly, plotregpoollist_mam15herb_siteonly, plotregpoollist_mam15gen_siteonly)[[task]]
name_i <- c('tstats_2015_gg_iucn', 'tstats_2015_gh_iucn', 'tstats_2015_ggh_iucn', 'tstats_2015_gran_iucn', 'tstats_2015_herb_iucn', 'tstats_2015_gen_iucn', 'tstats_2015_gg_siteonly', 'tstats_2015_gh_siteonly','tstats_2015_ggh_siteonly'. 'tstats_2015_gran_siteonly', 'tstats_2015_herb_siteonly', 'tstats_2015_gen_siteonly')[task]

tstats_i <- QTstats(traits = traits_i, ind.plot = factor(mam_capture_sitemerge$plotID[i_i]), sp = factor(mam_capture_sitemerge$taxonID[i_i]), reg.pool = pool_i, nperm = N_PERM) # It's QTstats because of the weighted mean
